...
# unbiased_color: distance at least 50 from biased color - random
unbiased_colours = np.array([random_different_enough_colour() for _ in range(10)])

# test_unbiased_colours: random color different from biased_colours and unbiased_colours
def test_colours():
    while True:
        x = np.random.choice(255, size=3)
...
tr_i = 800*NUM_CLASSES # train: 800 imgs per class
val_i = 100*NUM_CLASSES # val: 100 imgs per class
te_i = 100*NUM_CLASSES # test: 100 imgs per class
